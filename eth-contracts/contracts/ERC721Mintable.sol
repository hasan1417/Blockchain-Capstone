...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Cannot approve to the owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(msg.sender, msg.sender), "Only the owner or operator can approve");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Sender is not the owner of the token");
...
contract DarkIslandToken is ERC721Metadata("Real Estate Marketplace", "CAPSTONE", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
